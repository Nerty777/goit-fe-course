...
function initMap() {
  ...
  var arrayPolylineInfoWindowMarkers = []; // when "mouseover" polyline open InfoWindow

  polylines.map(function (item) {
    return google.maps.event.addListener(item.polyline, "mouseover", function () {
      var handlePolyline = item.polyline;
      var lat = (item.polyline.De.bounds.U + item.polyline.De.bounds.Y) / 2;
      var lng = (item.polyline.De.bounds.W + item.polyline.De.bounds.Z) / 2;
      deleteMarkersFromTheMap(arrayPolylineInfoWindowMarkers);
      var contentString = "\n      <div style=\"width: 193px;\"><span style=\"font-weight: 700;\">".concat(handlePolyline.nameRus, "</span>.<div style=\"display: flex; juctify-content: center;\"><div>\u041A\u043B\u0438\u043A\u0430\u0439 \u043D\u0430 \u043B\u0438\u043D\u0438\u044E \u043C\u0430\u0440\u0448\u0440\u0443\u0442\u0430</div><img style=\"display: block; margin-left: 5px; width: 20px; height: 20px;\"src=\"./img/clicker.svg\" alt=\"\u041A\u043B\u0438\u043A\u0430\u0439 \u043D\u0430 \u043B\u0438\u043D\u0438\u044E \u043C\u0430\u0440\u0448\u0440\u0443\u0442\u0430\"></div></div>");
...
function removeAllButOneRoute(name) {
  polylines.forEach(function (item) {
    if (item.name !== name) {
      ...
      item.polyline.setMap(map); // set center of polyline and init map on this center START

      setTimeout(function () {
        // set first and last point of polylines and they lat and lng
        var startLatLng = "lat: ".concat(item.polyline.De.bounds.U, ", lng: ").concat(item.polyline.De.bounds.W);
        var endLatLng = "lat: ".concat(item.polyline.De.bounds.Y, ", lng: ").concat(item.polyline.De.bounds.Z); // set center of polylines
