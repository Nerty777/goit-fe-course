...
$subject ="Новая заявка с сайта xml.kiev.ua/serg/";
...
$header .= "From: Новая заявка <nerty777@gmail.com>\n\n";	
$mail = mail("nerty777@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
